...
<h4><i class="fa fa-angle-right"></i> 공지사항</h4><hr>
			<thead>
			<tr>
			...
			<c:forEach var="article" items="${qnaList }">
				<tr height="30">
					...
					<td width="250"><c:if test="${article.re_level > 0 }">
						...
						href="<%=request.getContextPath() %>/board/content?num=${article.num}&pageNum=${pageNum}">${article.subject}</a>
